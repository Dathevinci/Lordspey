...
(async function runAutoUpdateTests() {
  ...
  assert.strictEqual(compareSemver('1.1.4', '1.1.4'), 0, 'Current version 1.1.4 == 1.1.4');
  assert.strictEqual(compareSemver('v1.1.4', '1.1.4'), 0, 'Prefixed v1.1.4 == 1.1.4');
  assert.strictEqual(compareSemver('1.2.0', '1.1.4'), 1, '1.2.0 > 1.1.4');
  assert.strictEqual(compareSemver('v1.3.0', '1.1.4'), 1, 'v1.3.0 > 1.1.4');
  assert.strictEqual(compareSemver('2.0.0', '1.1.4'), 1, '2.0.0 > 1.1.4');
  assert.strictEqual(compareSemver('1.1.3', '1.1.4'), -1, '1.1.3 < 1.1.4');
  assert.strictEqual(compareSemver('1.1.2', '1.1.4'), -1, '1.1.2 < 1.1.4');
  assert.strictEqual(compareSemver('1.0.0', '1.1.4'), -1, '1.0.0 < 1.1.4');
  ...
  // Fallback version in modal must use APP_VERSION (1.1.4), never 1.1.0
  window.showLordSpeyUpdateModal({});
  const curVerChipTest = getOrCreateElement('update-current-version-chip');
  assert(curVerChipTest.textContent.includes('v1.1.4'), 'Modal current version chip must display v1.1.4');
  window.closeLordSpeyUpdateModal();
