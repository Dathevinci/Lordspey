...
assert(['1.1.0', '1.1.1', '1.1.2', '1.1.3', '1.1.4'].includes(pkg.version), 'package.json version must be 1.1.0, 1.1.1, 1.1.2, 1.1.3, or 1.1.4');
...
assert(vaultPaneHtml.includes('v1.1.0') || vaultPaneHtml.includes('v1.1.1') || vaultPaneHtml.includes('v1.1.2') || vaultPaneHtml.includes('v1.1.3') || vaultPaneHtml.includes('v1.1.4'), 'Current version v1.1.0, v1.1.1, v1.1.2, v1.1.3, or v1.1.4 must be rendered in vault pane');
...
assert(guidesPaneHtml.includes('v1.1.0') || guidesPaneHtml.includes('v1.1.1') || guidesPaneHtml.includes('v1.1.2') || guidesPaneHtml.includes('v1.1.3') || guidesPaneHtml.includes('v1.1.4'), 'Current version v1.1.0, v1.1.1, v1.1.2, v1.1.3, or v1.1.4 must be rendered in guides pane');
